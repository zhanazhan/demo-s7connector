...
public class DataTNS1 {
    ...
    @S7Variable(byteOffset=128, type= S7Type.REAL) public double PT1_P1_1;
    @S7Variable(byteOffset=132, type= S7Type.REAL) public double PT1_P2_1;
    @S7Variable(byteOffset=136, type= S7Type.REAL) public double PT1_P3_1;
    @S7Variable(byteOffset=140, type= S7Type.REAL) public double PT1_P4_1;
    @S7Variable(byteOffset=144, type= S7Type.BOOL) public boolean STATE_P1;
    @S7Variable(byteOffset=146, type= S7Type.REAL) public double CURR_P1;
    @S7Variable(byteOffset=150, type= S7Type.BOOL) public boolean STATE_P2;
    @S7Variable(byteOffset=152, type= S7Type.REAL) public double CURR_P2;
    @S7Variable(byteOffset=156, type= S7Type.BOOL) public boolean STATE_P3;
    @S7Variable(byteOffset=158, type= S7Type.REAL) public double CURR_P3;
    @S7Variable(byteOffset=162, type= S7Type.BOOL) public boolean STATE_P4;
    @S7Variable(byteOffset=164, type= S7Type.REAL) public double CURR_P4;
    ...
    public double getPT1_P1_1() {
        return PT1_P1_1;
    }

    public void setPT1_P1_1(double PT1_P1_1) {
        this.PT1_P1_1 = PT1_P1_1;
    }

    public double getPT1_P2_1() {
        return PT1_P2_1;
    }

    public void setPT1_P2_1(double PT1_P2_1) {
        this.PT1_P2_1 = PT1_P2_1;
    }

    public double getPT1_P3_1() {
        return PT1_P3_1;
    }

    public void setPT1_P3_1(double PT1_P3_1) {
        this.PT1_P3_1 = PT1_P3_1;
    }

    public double getPT1_P4_1() {
        return PT1_P4_1;
    }

    public void setPT1_P4_1(double PT1_P4_1) {
        this.PT1_P4_1 = PT1_P4_1;
    }
